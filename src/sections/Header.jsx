                ...
                <div className="Container">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden md:flex gap-6 text-black/60 items-center parastoo-hero text-2xl">
                            ...
                            <button className="bg-black text-white px-4 py-2 rounded-lg font-medium inline-flex align-items justify-center tracking-tight hover:bg-gray-800 transition-colors">Contact Us</button>
                        </nav>
                    </div>
                </div>
            </div>
