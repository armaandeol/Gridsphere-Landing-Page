...
const Pointssection = () => {
  return (
    <div className="relative h-[400px] sm:h-[500px] md:h-[600px] w-full flex items-center sm:items-center items-start">
      {/* On mobile, items-start aligns content to the left; on sm and up, items-center centers it */}
      <CardSwap
        cardDistance={60}
        verticalDistance={70}
        delay={5000}
